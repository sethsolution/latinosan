            ...
            <div class="dropdown ">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    ...
                    <div class="row row-paddingless">
                        <!--begin:Item-->
                        <div class="col-6">
                            <a href="/latinosan" class="d-block py-10 px-5 text-center bg-hover-light border-right border-bottom">
                                <span class=""><i class="flaticon2-start-up text-success icon-xl-2x"></i></span>
                                <span class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">Latinosan</span>
                        ...
                        <!--begin:Item-->
                        <div class="col-6">
                            <a href="https://latinosanbolivia2022.com/" target="_blank" class="d-block py-10 px-5 text-center bg-hover-light border-right">
                                <span class=""><i class="fas fa-book text-success icon-xl-2x"></i></span>
                                <span class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">Latinosan 2022</span>
                                <span class="d-block text-dark-50 font-size-lg">Portal web</span>
                            </a>
                        </div>
                        <!--end:Item-->
                        <!--begin:Item-->
